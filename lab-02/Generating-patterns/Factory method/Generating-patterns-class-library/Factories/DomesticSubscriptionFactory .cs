...
namespace Generating_patterns_class_library.Factories
{
    public class DomesticSubscriptionFactory : ISubscriptionFactory
    {
        ...
        public DomesticSubscriptionFactory(decimal monthlyPrice, int minimalSubscriptionPeriod,
        ...
        {
            return new DomesticSubscription(_monthlyPrice, _minimalSubscriptionPeriod, _includedChannels, _accessToPremiumContent);
        }
    }
}
