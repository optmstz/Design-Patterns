...
namespace Generating_patterns_class_library.Factories
{
    public class PremiumSubscriptionFactory : ISubscriptionFactory
    {
        ...
        public PremiumSubscriptionFactory(decimal monthlyPrice, int minimalSubscriptionPeriod,
        ...
        {
            return new PremiumSubscription(_monthlyPrice, _minimalSubscriptionPeriod, _includedChannels, _accessToPremiumContent);
        }
    }
}
